...
MAX_TRAINING_EPISODES = 1000# Stop training automatically after this many counted episodes
...
# REDQ parameters
REDQ_ENSEMBLE_SIZE      = 5# N — critics in the ensemble
REDQ_TARGET_SUBSET      = 2      # M — random subset used when building the TD target (M <= N)
REDQ_UTD_RATIO          = 5# G — gradient updates per env step
...
REDQ_BATCH_SIZE         = 128# mini-batch for REDQ (bigger → better GPU utilisation)
